...
Rake::ExtensionTask.new('conventional_gitflow') do |ext|
  ext.lib_dir = 'lib/conventional_gitflow'
end

desc 'Publish the gem to RubyGems.org'
task :publish do
  version = ConventionalGitflow::VERSION
  system 'gem build'
